...
try:
    ...
    print(e)
    sys.exit(1)
if(testing): print("current inquiry mode is %d" % mode)
...
x = device_inquiry_with_with_rssi(sock)
#y = device_inquiry_with_with_rssi(sock)
#z = device_inquiry_with_with_rssi(sock)
